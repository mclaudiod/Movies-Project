      ...
      <nav className="bg-gray-800">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex grow justify-between flex-col md:flex-row">
            ...
            >
              <ul className="flex flex-col p-4 md:p-0 mt-4 border border-gray-700 rounded-lg md:gap-8 md:flex-row md:mt-0 md:border-0">
                <li className="flex text-white rounded md:hover:text-blue-500 text-white">
                  <Link
                    to="/now_playing"
